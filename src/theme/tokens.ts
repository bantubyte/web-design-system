...
const pikabooCssVariables = {
	...
	'--theme-primary-on-tint': '#5b2fd4',
	'--theme-primary-tint': 'rgb(107 63 228 / 0.15)',
	'--theme-secondary': '#7c3aed',
	'--theme-accent': '#fdff2e',
	'--theme-info': '#2fd7e6',
	'--theme-info-on-tint': '#155e75',
	'--theme-success': '#10b981',
	'--theme-success-on-tint': '#045c41',
	'--theme-warning': '#f59e0b',
	'--theme-warning-on-tint': '#92400e',
	'--theme-danger': '#dc2626',
	'--theme-danger-on-tint': '#991b1b',
	...
	'--theme-chart-cat-2': '#2f80ed',
	'--theme-chart-cat-3': '#e03381',
	'--theme-chart-cat-4': '#00a8a8',
	'--theme-chart-cat-5': '#1f9d63',
	'--theme-chart-cat-6': '#d98708',
	'--theme-chart-cat-7': '#8b5cf6',
	'--theme-chart-cat-8': '#cf3f2f',
	'--theme-chart-cat-9': '#5a6d8f',
	'--theme-chart-cat-10': '#7c6f00',
	'--theme-chart-cat-11': '#0f7a8a',
	'--theme-chart-cat-12': '#a855f7',
	'--theme-chart-primary': 'var(--theme-chart-cat-1)',
	'--theme-chart-secondary': 'var(--theme-chart-cat-2)',
	'--theme-chart-tertiary': 'var(--theme-chart-cat-3)',
	'--theme-chart-quaternary': 'var(--theme-chart-cat-4)',
	'--theme-chart-quinary': 'var(--theme-chart-cat-5)',
	'--theme-chart-senary': 'var(--theme-chart-cat-6)',
	'--theme-chart-seq-1': '#f7fbff',
	'--theme-chart-seq-2': '#deebf7',
	'--theme-chart-seq-3': '#c6dbef',
	'--theme-chart-seq-4': '#9ecae1',
	'--theme-chart-seq-5': '#6baed6',
	'--theme-chart-seq-6': '#4292c6',
	'--theme-chart-seq-7': '#2171b5',
	'--theme-chart-seq-8': '#08519c',
	'--theme-chart-seq-9': '#08306b',
	'--theme-chart-div-neg-4': '#991b1b',
	'--theme-chart-div-neg-3': '#dc2626',
	'--theme-chart-div-neg-2': '#f87171',
	'--theme-chart-div-neg-1': '#fecaca',
	'--theme-chart-div-neutral': '#f8fafc',
	'--theme-chart-div-pos-1': '#bbf7d0',
	'--theme-chart-div-pos-2': '#4ade80',
	'--theme-chart-div-pos-3': '#16a34a',
	'--theme-chart-div-pos-4': '#166534',
	'--theme-chart-axis': 'rgb(18 18 18 / 0.5)',
	'--theme-chart-grid': 'rgb(107 63 228 / 0.14)',
	'--theme-chart-tooltip-bg': '#121212',
	'--theme-chart-tooltip-fg': '#ffffff',
	'--theme-inverse-bg': '#160c32',
	'--theme-inverse-bg-deep': '#0a0418',
	'--theme-inverse-gradient':
		'linear-gradient(180deg, #160c32 0%, #131213 100%)',
	'--theme-inverse-foreground': '#ffffff',
	'--theme-inverse-foreground-muted': 'rgb(255 255 255 / 0.65)',
	'--theme-inverse-foreground-subtle': 'rgb(255 255 255 / 0.4)',
	'--theme-inverse-border': 'rgb(255 255 255 / 0.16)',
	'--theme-inverse-surface-soft': 'rgb(255 255 255 / 0.06)',
	'--theme-inverse-surface-medium': 'rgb(255 255 255 / 0.12)',
...
const pikabooDarkCssVariables = {
	...
	'--theme-primary-foreground': '#ffffff',
	'--theme-primary-on-tint': '#c4b5fd',
	'--theme-primary-tint': 'rgb(124 58 237 / 0.2)',
	'--theme-secondary': '#2fd7e6',
	'--theme-accent': '#fdff2e',
	'--theme-info': '#2fd7e6',
	'--theme-info-on-tint': '#a5f3fc',
	'--theme-success': '#34d399',
	'--theme-success-on-tint': '#a7f3d0',
	'--theme-warning': '#fbbf24',
	'--theme-warning-on-tint': '#fde68a',
	'--theme-danger': '#f87171',
	'--theme-danger-on-tint': '#fecaca',
	...
	'--theme-chart-cat-1': '#a78bfa',
	'--theme-chart-cat-2': '#2fd7e6',
	'--theme-chart-cat-3': '#fdff2e',
	'--theme-chart-cat-4': '#e03381',
	'--theme-chart-cat-5': '#34d399',
	'--theme-chart-cat-6': '#fbbf24',
	'--theme-chart-cat-7': '#f87171',
	'--theme-chart-cat-8': '#60a5fa',
	'--theme-chart-cat-9': '#c084fc',
	'--theme-chart-cat-10': '#f0abfc',
	'--theme-chart-cat-11': '#5eead4',
	'--theme-chart-cat-12': '#facc15',
	'--theme-chart-primary': 'var(--theme-chart-cat-1)',
	'--theme-chart-secondary': 'var(--theme-chart-cat-2)',
	'--theme-chart-tertiary': 'var(--theme-chart-cat-3)',
	'--theme-chart-quaternary': 'var(--theme-chart-cat-4)',
	'--theme-chart-quinary': 'var(--theme-chart-cat-5)',
	'--theme-chart-senary': 'var(--theme-chart-cat-6)',
	'--theme-chart-seq-1': '#130927',
	'--theme-chart-seq-2': '#211044',
	'--theme-chart-seq-3': '#332069',
	'--theme-chart-seq-4': '#4c2ea2',
	'--theme-chart-seq-5': '#6b3fe4',
	'--theme-chart-seq-6': '#8b5cf6',
	'--theme-chart-seq-7': '#a78bfa',
	'--theme-chart-seq-8': '#c4b5fd',
	'--theme-chart-seq-9': '#ede9fe',
	'--theme-chart-div-neg-4': '#7f1d1d',
	'--theme-chart-div-neg-3': '#f87171',
	'--theme-chart-div-neg-2': '#fecaca',
	'--theme-chart-div-neg-1': '#fee2e2',
	'--theme-chart-div-neutral': '#211044',
	'--theme-chart-div-pos-1': '#a7f3d0',
	'--theme-chart-div-pos-2': '#34d399',
	'--theme-chart-div-pos-3': '#10b981',
	'--theme-chart-div-pos-4': '#047857',
	'--theme-chart-axis': 'rgb(255 255 255 / 0.56)',
	'--theme-chart-grid': 'rgb(255 255 255 / 0.13)',
	'--theme-chart-tooltip-bg': '#ffffff',
	'--theme-chart-tooltip-fg': '#160c32',
	'--theme-inverse-bg': '#1f1448',
	'--theme-inverse-bg-deep': '#100624',
	'--theme-inverse-gradient':
		'linear-gradient(180deg, #1f1448 0%, #100624 100%)',
	'--theme-inverse-foreground': '#ffffff',
	'--theme-inverse-foreground-muted': 'rgb(255 255 255 / 0.7)',
	'--theme-inverse-foreground-subtle': 'rgb(255 255 255 / 0.45)',
	'--theme-inverse-border': 'rgb(255 255 255 / 0.18)',
	'--theme-inverse-surface-soft': 'rgb(255 255 255 / 0.08)',
	'--theme-inverse-surface-medium': 'rgb(255 255 255 / 0.14)',
	'--background': '260 71% 5%',
	'--foreground': '0 0% 100%',
	'--card': '258 61% 12%',
...
const primediaCssVariables = {
	...
	'--theme-primary-foreground': '#ffffff',
	'--theme-primary-on-tint': '#1e3a8a',
	'--theme-primary-tint': 'rgb(38 71 237 / 0.15)',
	'--theme-secondary': '#123f8a',
	'--theme-accent': '#2647ed',
	'--theme-info': '#2647ed',
	'--theme-info-on-tint': '#1e3a8a',
	'--theme-success': '#1f7a64',
	'--theme-success-on-tint': '#115e4a',
	'--theme-warning': '#d98708',
	'--theme-warning-on-tint': '#7c2d12',
	'--theme-danger': '#c62828',
	'--theme-danger-on-tint': '#7f1d1d',
	...
	'--theme-chart-cat-1': '#2647ed',
	'--theme-chart-cat-2': '#123f8a',
	'--theme-chart-cat-3': '#1f7a64',
	'--theme-chart-cat-4': '#8f9f16',
	'--theme-chart-cat-5': '#c05917',
	'--theme-chart-cat-6': '#c62828',
	'--theme-chart-cat-7': '#6d8fef',
	'--theme-chart-cat-8': '#5a6d8f',
	'--theme-chart-cat-9': '#0f766e',
	'--theme-chart-cat-10': '#7c3aed',
	'--theme-chart-cat-11': '#0369a1',
	'--theme-chart-cat-12': '#9333ea',
	'--theme-chart-primary': 'var(--theme-chart-cat-1)',
	'--theme-chart-secondary': 'var(--theme-chart-cat-2)',
	'--theme-chart-tertiary': 'var(--theme-chart-cat-7)',
	'--theme-chart-quaternary': 'var(--theme-chart-cat-8)',
	'--theme-chart-quinary': 'var(--theme-chart-cat-3)',
	'--theme-chart-senary': 'var(--theme-chart-cat-6)',
	'--theme-chart-seq-1': '#f8fbff',
	'--theme-chart-seq-2': '#e9eef7',
	'--theme-chart-seq-3': '#d5def0',
	'--theme-chart-seq-4': '#b8c8e8',
	'--theme-chart-seq-5': '#8fa8dc',
	'--theme-chart-seq-6': '#6585d2',
	'--theme-chart-seq-7': '#3f61c2',
	'--theme-chart-seq-8': '#2647ed',
	'--theme-chart-seq-9': '#123f8a',
	'--theme-chart-div-neg-4': '#7f1d1d',
	'--theme-chart-div-neg-3': '#c62828',
	'--theme-chart-div-neg-2': '#ef8f8f',
	'--theme-chart-div-neg-1': '#f9d4d4',
	'--theme-chart-div-neutral': '#f4f6fa',
	'--theme-chart-div-pos-1': '#cfeee5',
	'--theme-chart-div-pos-2': '#73c7b3',
	'--theme-chart-div-pos-3': '#1f7a64',
	'--theme-chart-div-pos-4': '#115e4a',
	'--theme-chart-axis': 'rgb(12 46 99 / 0.55)',
	'--theme-chart-grid': 'rgb(38 71 237 / 0.14)',
	'--theme-chart-tooltip-bg': '#0c2e63',
	'--theme-chart-tooltip-fg': '#ffffff',
	'--theme-inverse-bg': '#0c2e63',
	'--theme-inverse-bg-deep': '#061a3b',
	'--theme-inverse-gradient':
		'linear-gradient(180deg, #0c2e63 0%, #061a3b 100%)',
	'--theme-inverse-foreground': '#ffffff',
	'--theme-inverse-foreground-muted': 'rgb(255 255 255 / 0.7)',
	'--theme-inverse-foreground-subtle': 'rgb(255 255 255 / 0.45)',
	'--theme-inverse-border': 'rgb(255 255 255 / 0.18)',
